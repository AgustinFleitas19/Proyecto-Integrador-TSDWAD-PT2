...
('1', 'Cliente', 'Rol cliente, puede ver y utilizar los servicios de la web con limitaciones.'),
('2', 'Administrador', 'Rol administrador, puede ver, editar y utilizar sin limites.');

INSERT INTO `Usuario` (`nombre`, `apellido`, `idProvincia`, `idCiudad`, `correo`, `usuario`, `clave`, `idRol`) VALUES
('Agustin', 'Bengolea', 2, 13, 'agustinbengolea97@gmail.com', 'AgustinBen', '1234', 2);

INSERT INTO `MetodoPago` (`nombreMetodoP`) VALUES
('Mercado Pago'),
('Visa'),
('Mastercard');
...
SELECT * FROM Ciudad WHERE idProvincia = 1;
